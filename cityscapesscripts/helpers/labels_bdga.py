...
# --------------------------------------------------------------------------------
# Fonction "Pretty-print" pour `labels`.
# --------------------------------------------------------------------------------

# Fonction permettant de lire les étiquettes (`labels`)
def print_labels(labels):
    print("Liste des étiquettes de cityscapes :")
    print("")
...
# --------------------------------------------------------------------------------
# Quelques dictionnaires et tableaux de conversion utiles comme variables globales
# --------------------------------------------------------------------------------
